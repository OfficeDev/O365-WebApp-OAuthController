...
namespace O365_WebApp_OAuthController.Utils
{
    public class SettingsHelper
    {
        ...
        private static Uri _graphServiceEndpointUri = new Uri("https://graph.windows.net");
        ...
        public static Uri AADGraphServiceEndpointUri
        {
            get
            {
                return new Uri(_graphServiceEndpointUri,_tenant);
            }
        }
